...
// TODO: Add more head element such as `description - keys - tags - author - ...`
useHead({
  title: 'App Name - Lorem ipsum',
})
</script>
  ...
  <LandingLayout theme="light">
    <div class="landing-page-wrapper">
      ...
      <div id="Vuero-marketing" class="hero marketing-hero is-left is-fullheight">
        ...
        <div class="hero-body">
          <div class="container">
            <div class="columns is-vcentered is-justify-content-center mb-6">
      ...
      <!--About section-->
      <a id="about" name="about" aria-label="About Us" />
      <MarketingAbout />
      ...
      <!--Pricing section-->
      <a id="pricing" name="pricing" aria-label="Pricing" />
      <MarketingPricings />

      <!-- Testimonial section -->
      <a id="testimonial" name="testimonial" aria-label="Testimonial" />
      <MarketingTestimonial />

      <!-- Contact section -->
      <a id="contact" name="contact" aria-label="Contact" />
      <MarketingContact />
