  ...
  <div class="section has-bg-dots">
    <div class="container">
      ...
      <div class="section-title has-text-centered py-6">
        <h2 class="title is-2">About App Name</h2>
            ...
            <div class="columns is-multiline b-columns-half-tablet-p">
              <div class="column is-6">
                <div class="py-2 medium:py-4">
                  <h4 class="title is-5 is-narrow">How App Name started</h4>
              ...
              <div class="column is-6">
                <div class="py-2 medium:py-4">
                  <h4 class="title is-5 is-narrow">What App Name do</h4>
                  <p class="pt-2 max-w-3 text-medium">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                    videbimus.
                  </p>
              ...
              <div class="column is-6">
                <div class="py-2 medium:py-4">
                  <h4 class="title is-5 is-narrow">App Name values</h4>
                  <p class="pt-2 max-w-3 text-medium">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                    videbimus.
                  </p>
