    ...
    <div class="container">
      <div class="footer-head">
        <div class="head-text">
          ...
          <p>Get your App Name copy now</p>
        </div>
        <div class="head-action">
          <div class="buttons">
            ...
            <a href="#" class="button chat-button"> Chat with us </a>
          </div>
        </div>
      </div>
        ...
        <div class="column is-4">
          <div class="p-t-10 p-b-10">
            ...
            <div class="footer-description p-t-10 p-b-10">
              ...
              quas libero amet, possimus similique maxime facilis pariatur repudiandae.
            </div>
          </div>
          <div>
            <span class="moto">
              Designed and coded with
              <i aria-hidden="true" class="fas fa-heart text-danger"></i> by
              <span class="has-text-primary has-text-weight-bold is-underlined"
                >Aichemy-Dev</span
              >
            </span>
            <div class="social-links p-t-10 p-b-10">
              <a href="#" class="ml-0 pl-0">
                <span class="icon">
          ...
          <div class="columns is-flex-tablet-p">
            ...
            <div class="column">
              <ul class="footer-column">
                <li class="column-header">App Name</li>
                <li class="column-item"><a href="#Vuero-marketing">Home</a></li>
                <li class="column-item"><a href="#pricing">Pricing</a></li>
      ...
      <div class="footer-copyright has-text-centered">
        <p>
          <span role="img" aria-label="copyright">&copy;</span> 2010-2023 |
          <a href="https://App Name.dev">Aichemy dev</a> | All Rights Reserved.
        </p>
      </div>
    </div>
  </footer>
