...
const isLoggedIn = computed(() => __userStore.isLoggedIn)
  ...
  >
    ...
    <div class="navbar-menu" :class="[isMobileNavOpen && 'is-active']">
      <div class="navbar-start">
        ...
        <div class="navbar-item">
          <RouterLink
            ...
            @click.passive="
              () => {
                scrollTo('#pricing', 800, { offset: -50 })
                isMobileNavOpen = false
              }
            "
          >
        ...
        <div class="navbar-item">
          <RouterLink
            ...
            @click.passive="
              () => {
                scrollTo('#testimonial', 800, { offset: -50 })
                isMobileNavOpen = false
              }
            "
          >
        ...
        <div class="navbar-item">
          <RouterLink
            ...
            @click.passive="
              () => {
                scrollTo('#contact', 800, { offset: -50 })
                isMobileNavOpen = false
              }
            "
          >
      ...
      <div class="navbar-end">
        ...
        <template v-else>
          <div class="navbar-item">
            <VButton to="/app/dashboards" color="primary" rounded raised>
