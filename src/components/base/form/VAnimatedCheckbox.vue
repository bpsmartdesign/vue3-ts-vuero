...
.animated-checkbox {
  ...
  &.is-secondary {
    ...
    .checkmark {
      box-shadow: inset 0 0 0 var(--secondary) !important;
    }
  ...
  &.is-blue {
    ...
    .checkmark {
      box-shadow: inset 0 0 0 var(--blue) !important;
    }
  ...
  &.is-green {
    ...
    .checkmark {
      box-shadow: inset 0 0 0 var(--green) !important;
    }
  ...
  &.is-orange {
    ...
    .checkmark {
      box-shadow: inset 0 0 0 var(--orange) !important;
    }
  ...
  &.is-solid {
    .checkmark-circle {
      color: var(--fade-grey-dark-3) !important;
      stroke: var(--fade-grey-dark-3) !important;
    }

    .checkmark {
      box-shadow: inset 0 0 0 var(--fade-grey-dark-3) !important;
    }
  ...
  &.is-white {
    .checkmark-circle {
      color: var(--primary-light-22) !important;
      stroke: var(--primary-light-22) !important;
    }

    .checkmark {
      box-shadow: inset 0 0 0 var(--primary-light-22) !important;
    }
