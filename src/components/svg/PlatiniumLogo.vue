...
@keyframes is-roll-right {
  0% {
    fill: var(--dark-dark-7);
  }

  33% {
    fill: var(--dark-light-8);
  }

  66% {
    fill: var(--dark-light-40);
  }
...
@keyframes is-roll-bottom {
  ...
  33% {
    fill: var(--dark-light-24); // darken(#1ee8c0, 7%);
  }
...
@keyframes is-roll-left {
  0% {
    fill: var(--dark-light-15);
  }

  33% {
    fill: var(--dark-light-12); // lighten(#1ee8c0, 15%);
  }
